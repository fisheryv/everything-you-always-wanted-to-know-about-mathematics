...
\begin{center}
    \begin{tikzpicture}[thick]
        \draw (-5,2.5) -- (5,-2.5);
        \draw [color=red] (-5,-1.5) -- (0,0)  node[midway,below,sloped]{$\text{分割区域 1}$}
        -- (5,1.5) node[midway,above,sloped]{$\text{分割区域 2}$} ;
...
\begin{center}
    \begin{tikzpicture}[thick]
        \draw (-5,2.5) -- (5,-2.5);
        \draw (-5,-1.5) -- (5,1.5);
        \draw [color=red] (-5,1) -- (-1.8085,0.9043) node[midway,below,sloped]{$\small\text{分割区域 1}$} 
        -- (2.5758,0.7727) node[midway,above,sloped]{$\small\text{分割区域 2} $}
        -- (5,0.7) node[midway,below,sloped]{$\small\text{分割区域 3}$};
...
\begin{center}
    \begin{tikzpicture}[thick]
        \draw (-5,2.5) -- (5,-2.5);
        \draw (-5,-1.5) -- (5,1.5);
        \draw [color=red] (0,2.5) -- (-0.8333,0.4167) node[midway,right,sloped,rotate=-90]{$\small\text{分割区域 2}$} 
        -- (-1.1364,-0.341) node[midway,left,sloped,rotate=-90]{$\small\text{分割区域 1}$}
        -- (-2,-2.5) node[midway,right,sloped,rotate=-90]{$\small\text{分割区域 4}$};
