...
\begin{example}[斐波那契数列的封闭形式]
    ...
    \begin{proof}
        ...
        不难发现
        \begin{align*}
            \varphi^2 &= \left(\frac{1+\sqrt{5}}{2}\right)^2 = \frac{1+2\sqrt{5}+5}{4} = \frac{6+2\sqrt{5}}{4} \\
        ...
        \[\frac{1}{\sqrt{5}}\left(\varphi^1-(1-\varphi)^1\right) = \frac{1}{\sqrt{5}} (2\varphi-1) = \frac{1}{\sqrt{5}} (1+\sqrt{5}-1) = \frac{1}{\sqrt{5}} (\sqrt{5}) = 1\]
        ...
        \begin{align*}
            ...
            &= \frac{1}{\sqrt{5}}\left(\varphi^k-(1-\varphi)^k\right) + \frac{1}{\sqrt{5}}\left(\varphi^{k-1}-(1-\varphi)^{k-1}\right) & \text{归纳假设 } P(k), P(k-1)\\
            &= \frac{1}{\sqrt{5}}\left(\varphi^k+\varphi^{k-1}-(1-\varphi)^k-(1-\varphi)^{k-1}\right) & \textbf{化简}\\
            &= \frac{1}{\sqrt{5}}\left(\varphi^{k-1}(\varphi+1)-(1-\varphi)^{k-1}((1-\varphi)+1)\right) & \textbf{提取公因式}\\
            &= \frac{1}{\sqrt{5}}\left(\varphi^{k-1} \cdot \varphi^2-(1-\varphi)^{k-1}(2-\varphi)\right) & \textbf{根据(*1)}\\
            &= \frac{1}{\sqrt{5}}\left(\varphi^{k+1} -(1-\varphi)^{k-1}(1-\varphi)^2\right) & \textbf{根据(*2)}\\
            &= \frac{1}{\sqrt{5}}\left(\varphi^{k+1} -(1-\varphi)^{k+1}\right) & 
        \end{align*}
...
\begin{example}[集合的广义德摩根定律：]
    ...
    上面命题可以等价地写做：对于所有 $n \in \mathbb{N}$
