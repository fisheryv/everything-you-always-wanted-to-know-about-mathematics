...
\begin{theorem}[强数学归纳原理 (Strong PMI)]\label{theorem5.4.1}
    ...
    \begin{enumerate}[label=(\arabic*)]
        \item $P(1)$ 成立
        \item $\forall k \in \mathbb{N} \centerdot \left(\forall i \in [k] \centerdot P(i)\right) \implies P(k+1)$ 成立
    \end{enumerate}
...
强归纳法则可表述为：
\[\forall k \in \mathbb{N} \centerdot \left(P(1) \land P(2) \land P(3) \land \dots \land P(k)\right) \implies P(k+1)\]
...
\[\underbrace{\underbrace{\overbrace{\left(P(1)\right)}^{\text{基本情况为真}} \overbrace{\implies}^{\text{应用归纳步骤}} \overbrace{\left(P(2)\right)}^{\text{为真}}}_{\text{已知 } P(1) \land P(2)} \underbrace{\implies}_{\text{应用归纳步骤}} \underbrace{\left(P(3)\right)}_{\text{为真}}}_{\text{已知 } P(1) \land P(2) \land P(3)} \implies\left(P(4)\right) \implies \left(P(5)\right)\]
