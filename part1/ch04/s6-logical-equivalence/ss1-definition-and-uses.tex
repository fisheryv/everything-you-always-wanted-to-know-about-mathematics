...
\begin{example}
    ...
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    可见，无论 $P$ 和 $Q$ 的真值如何，$P \implies Q$ 与 $\neg Q \implies \neg P$ 具有相同的真值。故二者\emph{逻辑等价}，可以写做：
    \[(P \implies Q) \iff (\neg Q \implies \neg P)\]
...
\[\forall x \in \mathbb{R} \centerdot (x > 0) \iff \left(\frac{1}{x}>0\right)\]
...
\[\forall x \in \mathbb{R} \centerdot \left[\left((x > 0) \implies \left(\frac{1}{x}>0\right)\right) \land \left(\left(\frac{1}{x}>0\right) \implies (x > 0)\right)\right]\]
