...
\begin{exercise}
    ...
    \[T =\left\{(x, y) \in \mathbb{Z} \times \mathbb{Z} \mid 0 \le nx + y - (n + 1) \le n^2 - 1\right\}\]
    证明 $S \subseteq T$ 但 $S \ne T$。
\end{exercise}
...
\begin{exercise}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item 利用上述答案，写出 $\displaystyle{\left(\bigcup_{i \in I}A_i\right) - \left(\bigcup_{i \in I}B_i\right)}$ 的元素。
        \item 利用上述答案，写出 $\displaystyle{\left(\bigcap_{i \in I}A_i\right) - \left(\bigcap_{i \in I}B_i\right)}$ 的元素。
...
\begin{exercise}\label{exc:exercises3.11.22} 
    ...
    \[R = \left\{\left((a, b),(c, d)\right) \in P \times P \mid a + d = b + c \right\}\]
    \begin{enumerate}[label=(\alph*)]
        \item 找出三个不同的 $(c, d)$ 对，使得 $\left((1, 4),(c, d)\right) \in R$。
        \item 设 $(a, b) \in P$。证明 $\left((a, b),(a, b)\right) \in R$。
        \item 设 $\left((a, b),(c, d)\right) \in R$。证明 $\left((c, d),(a, b)\right) \in R$。
        \item 假设 $\left((a, b),(c, d)\right) \in R$ 且 $\left((c, d),(e, f)\right) \in R$。证明 $\left((a, b),(e, f)\right) \in R$。
    \end{enumerate}
\end{exercise}