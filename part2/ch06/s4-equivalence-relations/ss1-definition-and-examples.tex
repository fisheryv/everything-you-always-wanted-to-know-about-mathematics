...
\begin{itemize}
    ...
    \item \emph{传递性}：因为 $\forall x, y, z \in \mathbb{R} \centerdot \left(\lfloor x \rfloor = \lfloor y \rfloor \land \lfloor y \rfloor = \lfloor z \rfloor \right) \implies \lfloor x \rfloor = \lfloor z \rfloor$
\end{itemize}
