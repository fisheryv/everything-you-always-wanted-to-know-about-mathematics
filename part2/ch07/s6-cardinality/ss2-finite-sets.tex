...
\begin{proof}
    ...
    \begin{enumerate}[label=(\arabic*)]
        \item 若 $1 \le y \le a$，即假设 $y \in [a]$。则
            \[(h \circ H)(y) = h\left(f^{-1}(y)\right) = f\left(f^{-1}(y)\right)= \id_{[a]}(y) = y\]
            此处使用了 $f^{-1}(y) \in A$ 这一事实。
        \item 若 $a + 1 \le y \le b$。即假设 $y-a \in [b]$。则
            \begin{align*}
                (h \circ H)(y) = h(H(y)) &= h\left(g^{-1}(y-a)\right) = g\left(g^{-1}(y-a)\right)+a \\
                &= \id_{[b]}(y - a) + a = (y - a) + a = y
            \end{align*}
    ...
    \begin{enumerate}[label=(\arabic*)]
        \item 若 $x \in A$，则
            \[(H \circ h)(x) = H(h(x)) = H\left(f(x)\right) = f^{-1}\left(f(x)\right) = \id_A(x) = x\]
           此处使用了 $f(x) \in [a]$ 这一事实。
        \item 若 $x \in B$。则
        \begin{align*}
            (H \circ h)(x) = H(h(x)) &= H\left(g(x)+a\right) = g^{-1}\left(\left(g(x)+a\right)-a\right)\\
            &= g^{-1}\left(g(x)\right) = \id_B(x) = x
        \end{align*}
