    ...
    \begin{proofs}{证明双射：}
        ...
        \begin{itemize}
            \item 若 $n$ 为偶数。则 $F(n) = -\frac{n}{2} + 1$。显然 $\frac{n}{2} \ge 1$，所以 $-\frac{n}{2} + 1 \le -1+1=0$。这意味着
                  \begin{align*}
                      (f \circ F)(n) & = f(F(n)) = f\left(-\frac{n}{2}+1\right) = -2\left(-\frac{n}{2}+1\right)+2 \\
                                     & = \left(\frac{2n}{2}-2\right)+2=n
                  \end{align*}
            \item 若 $n$ 为奇数。则 $F(n) = \frac{n+1}{2}$。显然 $n+1 \ge 2$，所以 $\frac{n+1}{2} \ge 1$。这意味着
                  \begin{align*}
                      (f \circ F)(n) & = f(F(n)) = f\left(\frac{n+1}{2}\right) = 2\left(\frac{n+1}{2}\right)-1 = \frac{2n+2}{2}-1 \\
                                     & = (n + 1) -1 = n
                  \end{align*}
        \end{itemize}
...
\begin{example}[$\mathbb{N} \times \mathbb{N}$ 为可数无限集]\label{ex:example7.6.13}
    ...
    \begin{proofs}{证明双射：}
        ...
        \begin{itemize}
            ...
            \item 若  $n$ 为偶数，则考虑 $\frac{n}{2}$。为了引出矛盾而假设 $\frac{n}{2}$ 可以表示为 $2$ 的幂乘以一个奇数的形式，即假设 $\frac{n}{2} \in \im_f (\mathbb{N} \times \mathbb{N})$。这意味着 $\exists (x, y) \in \mathbb{N} \times \mathbb{N} \centerdot f(x, y) = \frac{n}{2}$。给定这样的 $(x,y)$。然后考虑 $f(x + 1, y)$（这是有效的，因为 $x+1 \in \mathbb{N}$）。我们发现
                  \[f(x + 1, y) = 2^{x+1} \cdot (2y - 1) = 2 \cdot \left(2^x \cdot (2y - 1)\right) =  2 \cdot f(x, y) = 2 \cdot \frac{n}{2} = n\]
...
\begin{example}[$\mathbb{Q}$ 是可数无限集]
    ...
    \begin{enumerate}[label=(\arabic*)]
        \item \textbf{直观解释：}\\
              ...
              \[\mathbb{Q} \;\text{``}=\text{''}\; \left(\text{``}\mathbb{N} \times \mathbb{N}\text{''}\right) \cup \left(\text{``}-(\mathbb{N} \times \mathbb{N})\text{''}\right) \cup \{0\}\]
...
\begin{proof}
    ...
    \[\forall (x, y) \in A \times B \centerdot h(x, y) = \left(f(x), g(y)\right)\]
    我们声称 $h$ 为双射。因为 $f, g$ 均可逆，定义函数 $H : \mathbb{N} \times \mathbb{N} \to A \times B$ 为
    \[\forall (k, \ell) \in \mathbb{N} \times \mathbb{N} \centerdot H(k, \ell) = \left(f^{-1}(k), g^{-1}(\ell)\right)\]
    我们声称 $H = h^{-1}$。因为
    \begin{align*}
        \forall (x, y) \in A \times B \centerdot (H \circ h)(x, y) & = H(h(x, y)) = H \left(f(x), g(y)\right)           \\
                                                                   & = \left(f^{-1}(f(x)), g^{-1}g((y))\right) = (x, y)
    \end{align*}
    且
    \begin{align*}
        \forall (k, \ell) \in \mathbb{N} \times \mathbb{N} \centerdot (h \circ H)(k, \ell) & = h(H(k, \ell)) = h\left(f^{-1}(k), g^{-1}(\ell)\right)  \\
                                                                                           & = \left(f(f^{-1}(k)), g(g^{-1}(\ell))\right) = (k, \ell)
    \end{align*}
...
\begin{proof}
    ...
    定义函数 $F : A \to \mathbb{N} \times \mathbb{N}$。给定任意 $x \in A$，我们知道 $\exists n \in \mathbb{N} \centerdot x \in A_n$ 且 $n$ 是\emph{唯一的}。（这是因为给定的集合互不相交）。令 $F(x) = \left(n, fn(x)\right)$。
...
\[\forall \varepsilon \in P \centerdot \exists M \in \mathbb{N} \centerdot \forall n \in \mathbb{N} \centerdot \left(n > M \implies \left|\frac{1}{x}\right| < \varepsilon \right)\]
