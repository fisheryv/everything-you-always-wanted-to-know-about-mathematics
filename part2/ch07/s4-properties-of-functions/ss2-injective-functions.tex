...
\[\neg \left(\forall a_1, a_2 \in A \centerdot a_1 \ne a_2 \implies f(a_1) \ne f(a_2)\right) \iff \left(\exists a_1, a_2 \in A \centerdot a_1 \ne a_2 \land f(a_1) = f(a_2)\right)\]
...
\begin{example}
    ...
    通过以下示例帮助你理解：
    \begin{align*}
        F\left(\{1\}\right)       & = \bigcup_{a \in \{1\}} \{a, -a\} = \{-1,1\}                                 \\
        F\left(\{1,3,5\}\right)   & = \bigcup_{a \in \{1,3,5\}} \{a, -a\} = \{-1,1\} \cup \{-3,3\} \cup \{-5,5\} \\
                               & = \{-5,-3,-1,1,3,5\}                                                         \\
        F\left(\varnothing\right) & = \bigcup_{a \in \varnothing} \{a, -a\} = \varnothing                        \\
        F\left(\mathbb{N}\right)  & = \mathbb{Z} - \{0\}
    \end{align*}
